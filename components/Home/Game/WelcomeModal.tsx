...
const WelcomeModal = () => {
  ...
  useEffect(() => {
    let modal_hidden = localStorage.getItem('modalVisible')
    if (!modal_hidden)  {
  ...
  if(!modalVisible) return null;
	...
	return (
<div className={`${!modalVisible ? 'hidden' : '' } relative z-10 aria-labelledby="modal-title" role="dialog" aria-modal="true"`}>
