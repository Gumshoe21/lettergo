...
const WelcomeModal = () => {
  ...
  return (
    <div
      className={`${!modalVisible && modalVisible !== 'false' ? 'hidden' : ''
        ...
        <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          <div className="animate-[fadeIn_1s_ease-in-out] relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
            <div className="flex items-center justify-center">
              <div className="flex flex-col items-center justify-center gap-20 mt-3 text-center sm:mt-5">
                <h3
                  className="text-6xl font-serif font-md leading-6 text-gray-900 "
                  id="modal-title"
                >
                  LetterGo
                </h3>
                <div className="mt-2">
                  <p className="text-2xl text-gray-500">
                    The game that tests your vocabulary.
                  </p>
                </div>
                <button
                  type="button"
